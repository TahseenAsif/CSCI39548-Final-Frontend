...
import { addEmployeeThunk, fetchAllEmployeesThunk } from '../../store/thunks';
import { fetchAllEmployees } from '../../store/actions/actionCreators';
import { allEmployees } from '../../store/reducers';
...
class NewEmployeeContainer extends Component {
    ...
    handleChange = event => {
      ...
      let employees = this.props.getEmployees();
        let employeesLenth = employees[0];
        console.log(employeesLenth);
    }
...
const mapDispatch = (dispatch) => {
    return({
        ...
        getEmployees: () => dispatch(fetchAllEmployeesThunk())
    })
}
